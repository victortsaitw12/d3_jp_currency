...
# web
docker build -t victortsaitw12/d3-practice-web:v6 .
docker push victortsaitw12/d3-practice-web:v6
...
# crawler
docker build -t victortsaitw12/d3-practice-crawler:v2 .
docker push victortsaitw12/d3-practice-crawler:v2
